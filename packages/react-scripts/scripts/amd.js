...
const config = isDev
  ? require('../config/webpack.config.amd.dev')
  : require('../config/webpack.config.amd.prod');

const buildDir = paths.appAmdBuild;
...
function copyPublicFolder() {
  fs.copySync(
    path.resolve(paths.appPublic, 'fonts'),
    path.resolve(paths.appAmdBuild, 'static/fonts'),
    { dereference: true }
  );
}
